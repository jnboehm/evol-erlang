...
\begin{scope}[start chain=0 going right,node distance=0mm]
    ...
    \node[on chain=0,tape, blue]          (d)     {$v'_4$};
    \node[on chain=0,tape, blue]          (e)     {$v'_5$};
    \node[on chain=0,tape, blue]          (f)     {$v'_6$};
    \node[on chain=0,tape, blue]          (g)     {$v'_7$};
    \node[on chain=0,tape, blue]          (h)     {$v'_8$};
    \node[on chain=0,tape, blue]          (i)     {$v'_9$};
    \node[on chain=0,tape, blue]          (l)     {$v'_{10}$};
    \node[on chain=0,tape, blue]          (l)     {$v'_{11}$};
    \node[on chain=0,tape, blue]          (l)     {$v'_{12}$};
    \node[on chain=0,tape, blue]          (m)     {$v'_{13}$};
    \node[on chain=0,tape, blue]          (n)     {$v'_{14}$};
