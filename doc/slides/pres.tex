...
% TEXT
    ...
    \path[->] (B) edge [bend left=0] node  {5} (D);
    \path[->] (D) edge [bend left=0] node  {5} (C);
    \path[->] (C) edge [bend left=0] node  {5} (E);
    \path[->] (E) edge [bend left=0] node  {5} (A);
    \end{tikzpicture}
    }
    ...
    \path[->] (E) edge [bend left=0] node  {5} (C);
    \path[->] (C) edge [bend left=0] node  {5} (D);
